                    ...
                    <div class="profile-user-info profile-user-info-striped">
                       <div class="profile-info-row">
                            ...
                            <div class="profile-info-value viewname1">
                                <span class="editable" id="signup"><?php echo $r->rec_no ?></span>
                            </div>
                        </div>
                        <div class="profile-info-row">
                            <div class="profile-info-name viewname"> Daily Wages </div>

                            <div class="profile-info-value viewname1">
                                <span class="editable" id="signup"><?php echo $r->daily ?></span>
                            </div>
                        </div>
