        ...
        <div class="col-xs-12">
            ...
            <div>
                ...
                <table id="dyntableExport" class="table table-bordered table-hover table-responsive">
                    ...
                    <?php
                    $q = $this->db->query("Select do_admission, status, name, reg_no, course, comments from student where MONTH(do_admission) =" . $month . " and YEAR(do_admission) =" . $year . "");
                    if ($q->num_rows() > 0) {
                        $i = 1;
                        foreach ($q->result() as
                                $r) {
        ...
        <div class="col-xs-12">
            ...
            <div>
                ...
                <table id="dyntableExport" class="table table-bordered table-hover table-responsive">
                    ...
                    <?php
                    $q = $this->db->query("Select do_admission, name, status, reg_no, course, comments from student where MONTH(do_admission) =" . date('m') . " and YEAR(do_admission) =" . date('Y') . "");
                    $i = 1;
                    foreach ($q->result() as
                            $r) {
                        $absent = AdminLTE::count_lastweek("status", 2, $r->reg_no);
