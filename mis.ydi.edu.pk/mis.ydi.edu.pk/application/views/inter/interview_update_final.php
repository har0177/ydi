          ...
          TRAINEE'S PROFILE
            ...
            <table id="" class="table table-striped table-bordered table-hover">
                ...
                <th><input type="text" name="idate"  class="form-control datepicker" value="<?php echo $r->date  ?>"></th>
                    ...
                    <tr>
                        <th>EDIR Number</th>
                        <td><input type="text" name="edir" value="<?php echo $r->edir ?>" class="form-control" placeholder="EDIR Number"></td><th>Interview Fee</th>
                <th><input type="number" name="fee" class="form-control" value="<?php echo $r->fee ?>"></th>
            </tr>
            <tr>
                <th>Status</th>
                <th>    <?php
                                        ...
                                        //$options = $tmp;
                                        echo form_dropdown('status', $status, set_value('status', $r->status), $data2);
                                        ?>
        ...
        <table id="" class="table table-striped table-bordered table-hover">
            ...
            <tr><th>Body Language</th>
                <th><input type="radio" style="height: 15px;" name="blang[]" <?php if(explode("-",$r->blang)[0] == 80){
                    echo "checked";
                } ?>  class="form-control" value="80-Trainee used his/her body language most of the time to convey his ideas more proficiently.">Trainee used his/her body language most of the time to convey his ideas more proficiently.</th>
            ...
            <tr><th>Confidence Level</th>
                ...
                <th><input type="radio" style="height: 15px;" name="clevel[]"  <?php if(explode("-",$r->clevel)[0] == 40){
                    echo "checked";
                } ?> class="form-control" value="40-Trainee’s confidence level was low and was hesitant to share ideas and face the interviewer.">Trainee’s confidence level was low and was hesitant to share ideas and face the interviewer.</th>
                <th><input type="radio" style="height: 15px;" name="clevel[]"  <?php if(explode("-",$r->clevel)[0] == 20){
                    echo "checked";
                } ?> class="form-control" value="20-Trainee was very hesitant and couldn’t express himself / herself well in front of interviewer.">Trainee was very hesitant and couldn’t express himself / herself well in front of interviewer.</th>
