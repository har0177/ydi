...
<div class="page-header">
    <h4 style="text-align: center; font-family: 'Baskerville Old Face'">    
...
<div class="row">
    <div class="col-xs-12">
        ...
        <table id="" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <th>EDIR Number</th>
                <th><input type="text"  value="<?php echo $r->edir ?>" name="edir" class="form-control" placeholder="EDIR Number"></th>
                <th>Interview Fee</th>
                <th><input type="number" name="fee" class="form-control" value="500"></th>
            </tr>
            <tr>
                <th>Status</th>
                <th>    <?php
                                        ...
                                        //$options = $tmp;
                                        echo form_dropdown('status', $status, set_value('status'), $data2);
                                        ?>
