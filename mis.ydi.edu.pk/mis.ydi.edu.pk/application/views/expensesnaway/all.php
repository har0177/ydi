<div class="page-header">
    <h1> 
        ...
        <a href="<?php echo site_url('expensesnaway/create'); ?>" class="btn btn-sm btn-success pull-right">  
 ...
 <td> <?php echo $i ?></td>
                            ...
                            <td>
                                <div class="hidden-sm action-buttons">
                                    <a title="View Expanses Form" class="green" href="<?php echo site_url('expensesnaway/view/' . $r->id) ?>">
                                        <i class="ace-icon fa fa-eye bigger-130"></i>
                                    </a>

                                    <a title="Update Expanses Form" class="light-grey" href="<?php echo site_url('expensesnaway/edit/' . $r->id) ?>">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>

                                    <a title="Delete Expanses Form" class="red" onclick="return confirm('Are You Sure Want to Delete it?')" href="<?php echo site_url('expensesnaway/delete/' . $r->id) ?>">
