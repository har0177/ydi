            ...
            <div class="navbar-container" id="navbar-container">
                ...
                <div class="navbar-buttons navbar-header pull-right" role="navigation">
                    <ul class="nav ace-nav">
                        ...
                        <li><a href="<?php echo base_url('cardmaker/profile') ?>"><i class="ace-icon fa fa-user"></i>Profile</a></li>
                        <li><a href="<?php echo base_url('cardmaker/logout'); ?>"> <i class="ace-icon fa fa-power-off"></i>Logout</a> </li>
                    </ul>
                </div>
        ...
        <div class="main-container" id="main-container">
            <div id="sidebar" class="sidebar responsive">
                <ul class="nav nav-list">
                    <li class="active">
                        <a href="<?php echo base_url('cardmaker') ?>">
                            <i class="menu-icon fa fa-tachometer"></i>
                            <span class="menu-text"> Dashboard </span>
                        </a> <b class="arrow"></b>
                    </li>
                    <li class="">
                        <a href="<?php echo site_url('cardmaker/idcards'); ?>">
                            <i class="menu-icon fa fa-photo"></i> Students ID Cards</a>
                        <b class="arrow"></b>
                    </li>
