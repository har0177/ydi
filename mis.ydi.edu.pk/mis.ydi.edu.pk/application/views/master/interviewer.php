            ...
            <div class="navbar-container" id="navbar-container">
                ...
                <div class="navbar-buttons navbar-header pull-right" role="navigation">
                    <ul class="nav ace-nav">
                        ...
                        <li><a href="<?php echo base_url('interviewer/profile') ?>"><i class="ace-icon fa fa-user"></i>Profile</a></li>
                        <li><a href="<?php echo base_url('interviewer/logout'); ?>"> <i class="ace-icon fa fa-power-off"></i>Logout</a> </li>
                    </ul>
                </div>
        ...
        <div class="main-container" id="main-container">
            <div id="sidebar" class="sidebar responsive">
                <ul class="nav nav-list">
                    <li class="active">
                        <a href="<?php echo base_url('interviewer') ?>">
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="<?php echo site_url('interviewer/all'); ?>"> <i class="menu-icon fa fa-book"></i> All Students </a>
                                <b class="arrow"></b>
                            </li>
                             <li class="">
                                <a href="<?php echo site_url('interviewer/all_observations'); ?>"> <i class="menu-icon fa fa-book"></i> All Observations </a>
                                <b class="arrow"></b>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="">
                                <a href="<?php echo site_url('admin/attendance/search'); ?>">
                                    <i class="menu-icon fa fa-plus-square"></i>  Add Attendance  </a> <b class="arrow"></b></li>
                            <li class="">
                                <a href="<?php echo site_url('admin/attendance/search_week'); ?>">
                                    <i class="menu-icon fa fa-dashboard"></i> Search Weekly </a>
                                <b class="arrow"></b>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="<?php echo site_url('expensesinter'); ?>">
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            <li class="">
                                <a href="<?php echo site_url('interviewer/reports'); ?>">
                                    <i class="menu-icon fa fa-adjust"></i> Admissions / Drop Out</a>
                                <b class="arrow"></b>
                            </li> <li class="">
                                <a href="<?php echo site_url('interviewer/reports_struckoff'); ?>">
                                    <i class="menu-icon fa fa-adjust"></i> Drop Out</a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="<?php echo site_url('interviewer/reports_all'); ?>">
                                    <i class="menu-icon fa fa-adjust"></i> All Students </a>
                                <b class="arrow"></b>
                            </li>
                            <li class="">
                                <a href="<?php echo site_url('interviewer/logs'); ?>">
