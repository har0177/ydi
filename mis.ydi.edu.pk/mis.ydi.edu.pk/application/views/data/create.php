...
<div class="row">
                ...
                <div class="widget-main">
                    <div id="fuelux-wizard-container">
                        ...
                        <div class="step-content pos-rel">
                            <?php echo form_open_multipart('trainer/upload_data', ['class' => 'form-horizontal']); ?>
                            <fieldset >
  ...
  <select required="" name="course" class="select2">
                            ...
                            foreach ($emp_course as
                                ...
                                ?>
                                        <option value="<?php echo $value ?>"><?php echo $course ?></option>
                                  <?php      
                                    } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="text" id="name" required="" name="topic" placeholder="Topic Name" class="col-xs-12 col-sm-9" />
                                        </div>
                                    </div>
                                </div>
...
<div class="form-group">
                                ...
                                <h3 style='text-align: center'></h3>
                                 <div class="form-group">
                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right">Video Link:</label>

                                    <div class="col-xs-12 col-sm-9">
                                        <div class="clearfix">
                                            <input type="text" id="name" name="link" placeholder="Video Link" class="col-xs-12 col-sm-9" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-4 col-sm-offset-3">
                                        <label>
                                            <input type="submit" name="submit" value="Upload Data" class="btn btn-lg btn-success">
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
