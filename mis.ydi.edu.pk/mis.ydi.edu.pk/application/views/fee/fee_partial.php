<div class="page-header">
    <h1> 
        ...
        Partially Paid <?php echo $heading; ?>
...
<div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right">Fee Paid:</label>

                                <div class="col-xs-12 col-sm-9">
                                    <div class="clearfix">
                                        <input type="number" id="name" required="" name="monthly"  class="col-xs-12 col-sm-6" />
                                    </div>
                                </div>
                            </div>
 <div class="form-group">
