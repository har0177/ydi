<div class="page-header">
    <h1>
        ...
        <a href="<?php echo site_url('admin/bank'); ?>" class="btn btn-sm btn-success pull-right">
                            ...
                            <fieldset >
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-4 col-sm-offset-3">
                                        <label>
                                            <input type="submit" name="submit" value="Update Bank" class="btn btn-lg btn-success">
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
