...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> 
            ...
            Make New <?php echo $heading; ?> Sheet of Course <?php echo AdminLTE::student_course($this->uri->segment(3)) ?> for Date: <?php echo date("d-M-Y"); ?>
...
$(function()
{
  $('#theform').submit(function(){
    ...
    <section class="content">
        <div class="box">
            <div class="box-body">
                <?php echo form_open('trainer/add_attend/'.$this->uri->segment(3), ['class' => 'form-horizontal', 'id' => 'theform']); ?>
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-4 col-sm-offset-3">
                        <label>
                            <input type="submit" name="submit" id="btnsubmit" value="Add Attendance" class="btn btn-lg btn-success">
                        </label>
                    </div>
                </div>
                </form>
