    ...
    <div class='col-xs-12'>
        ...
        <div class='col-md-12'>
            ...
            <div class='form-group'>
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="status">Mobile Number: </label>
            ...
            <div class='form-group'>
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="status">Message: </label>
