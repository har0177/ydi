...
<h3>Strategy used for Evaluation: <?php echo $rr->stra ?> </h3>
 ...
 <tr>
    ...
    <div class="page-header">
        <a href="<?php echo site_url('nawaytakay/monthly_update/' . $r->regno); ?>" class="btn btn-sm btn-success pull-right hidden-print">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <br>
            <br>
         <h3>Strategy used for Evaluation: <?php echo $r->stra ?> </h3>
            <table class="table table-striped table-bordered table-condensed idd">
                <thead>
                    <tr>
                        <th>
                ...
                <tbody>
                    <tr><th style="width: 25%">Learned Vocabulary</th>
                        <td style="width: 15%"><?php echo explode(":", $r->lc)[0]; ?></td>
                        <td style="width: 10%"><?php echo explode(":", $r->lc)[1]; ?></td>
                        <td style="width: 55%"><?php echo explode(":", $r->lc)[2]; ?></td>
                    </tr>
                    <tr><th >Confidence</th>

                        <td><?php echo explode(":", $r->conf)[0]; ?></td>
                        <td><?php echo explode(":", $r->conf)[1]; ?></td>
                        <td><?php echo explode(":", $r->conf)[2]; ?></td>
                    </tr>
                    <tr><th >Sentence Structure</th>
                        <td><?php echo explode(":", $r->ss)[0]; ?></td>
                        <td><?php echo explode(":", $r->ss)[1]; ?></td>
                        <td><?php echo explode(":", $r->ss)[2]; ?></td>
                    </tr>
                    <tr><th >Word Pronunciation</th>
                        <td><?php echo explode(":", $r->wp)[0]; ?></td>
                        <td><?php echo explode(":", $r->wp)[1]; ?></td>
                        <td><?php echo explode(":", $r->wp)[2]; ?></td>
                    </tr>
                    <tr><th >Spelling</th>
                        <td><?php echo explode(":", $r->sp)[0]; ?></td>
                        <td><?php echo explode(":", $r->sp)[1]; ?></td>
                        <td><?php echo explode(":", $r->sp)[2]; ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th><?php echo $r->marks ?></th>
                        <th><?php echo $r->tmarks ?></th>
                    </tr>
            </table>
    ...
    <?php
    $query = $this->db->query("Select * from report_naway where regno = '$r->regno' order by id DESC LIMIT 1");
    foreach ($query->result() as
            $value) {
        ?>
        <script>
    ...
    <table id="" class="table table-striped table-bordered table-hover table-condensed words">
        ...
        <tbody>
                ...
                <?php
                $word = $this->db->query("Select * from week_words where month = MONTH('$r->date') order by id ASC");
                if ($word->num_rows() > 0) {
                    foreach ($word->result() as
                            $w) {
                        for ($i = 1;
