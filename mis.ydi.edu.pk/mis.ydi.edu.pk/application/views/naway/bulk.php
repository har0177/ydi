<div class="page-header">
    <h1>
        ...
        <a href="<?php echo site_url('nawaytakay/dashboard'); ?>" class="btn btn-sm btn-success pull-right">
                ...
                <div class="col-xs-12 col-sm-9">
                    ...
                    <select name="sender[]" class="select2" multiple="">
                        ...
                        foreach ($query->result() as
                                $r) {
                            if (empty(AdminLTE::student_data($r->regno, "contact"))) {
                                continue;
                            }
                            echo "<option value='".AdminLTE::student_data($r->regno, "contact")."'>".AdminLTE::student_name($r->regno) . " - ". $r->regno. " </option>";
                        }
                        ?>
